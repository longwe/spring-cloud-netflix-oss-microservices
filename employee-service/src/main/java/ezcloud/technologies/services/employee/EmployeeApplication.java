package ezcloud.technologies.services.employee;
...
import ezcloud.technologies.services.employee.model.Employee;
import ezcloud.technologies.services.employee.repository.EmployeeRepository;
...
public class EmployeeApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("ezcloud.technologies.services.employee.controller"))
